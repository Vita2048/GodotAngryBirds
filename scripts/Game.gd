...
func _build_levels() -> void:
	levels = [
		...
		{"birds":["bird_l","bird_m","bird_m","bird_s","bird_s"],
		 ...
		 "blocks":[
			# Left tower
			{"x":740,"y":630,"w":40,"h":100,"type":"stone"},
			{"x":860,"y":630,"w":40,"h":100,"type":"stone"},
			{"x":800,"y":565,"w":160,"h":40,"type":"stone"},
			
			# Right tower
			{"x":1140,"y":630,"w":40,"h":100,"type":"stone"},
			{"x":1260,"y":630,"w":40,"h":100,"type":"stone"},
			{"x":1200,"y":565,"w":160,"h":40,"type":"stone"},
			
			# Middle connectors
			{"x":800,"y":510,"w":30,"h":110,"type":"wood"},
			{"x":1200,"y":510,"w":30,"h":110,"type":"wood"},
			{"x":1000,"y":505,"w":420,"h":30,"type":"stone"},
			...
			{"x":1000,"y":265,"w":100,"h":25,"type":"stone"},
			{"x":1000,"y":205,"w":40,"h":110,"type":"glass"}
		]}
	]
